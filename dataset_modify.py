...
df = pd.read_csv('/Users/zzx/Desktop/timesfm/News/Facebook_Obama_transpose_final.csv')
...
result_df.to_csv('/Users/zzx/Desktop/timesfm/News/Facebook_Obama_transpose_timesfm.csv', index=False)